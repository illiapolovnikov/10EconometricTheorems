...
Trivially, if $A_n$ and $B_n$ converge in probability to constants $a$ and $b$, then $A_nX_n + B_n \xrightarrow{p} aX+b$. Note that if $A_n$ or $B_n$ do not converge in probability to constants, and instead converge towards some distribution, then Slutsky's Theorem does not hold. 
