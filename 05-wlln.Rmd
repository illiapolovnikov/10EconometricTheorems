...
The variance of $Y_i$ is also recoverable. First note three basic features of variance: if $a$ is a constant, and $X$ and $Y$ are random variables, $var(a) = 0$; $var(aX) = a^2var(X)$; and from the variance of a sum $var(X \pm Y) = var(X)+var(Y) and $var(X \pm a) = var(X)$. Therefore:
